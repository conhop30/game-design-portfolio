    ...
    cards: [
      {
        ...
        recall: 1,
        type: "Ability",
        text: `Make a <strong>Spellcast roll (12)</strong> to target a creature within Close range. On a success, that creature can make their next attack roll with advantage. If it succeeds, you can clear a Stress.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "#2",
      ...
      },
      {
        ...
        recall: 1,
        type: "Ability",
        text: `Once per rest, when you mark 1 or more Hit Points from an adversary, you can <strong>make a Spellcast reaction roll</strong>. On a succes, cause them to mark Stress equal to your tier. If you succeed with Hope, ignore the exhaust limit.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "#4",
      ...
      },
      {
        ...
        recall: 1,
        type: "Ability",
        text: `When you <em>Prepare</em> as a downtime move with an ally, you can both clear a Stress.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "#10",
        ...
        recall: 2,
        type: "Ability",
        text: `When an adversary that is not a Solo, Leader, or other strong-willed adversary type sees one of those strong-willed adversaries mark 1 or more Hit Points, you can <strong>make a Spellcast roll</strong> to persuade them to join your side. On a success, you can command them to make an attack against another target within Close range of them. If it's a success with Fear, they do so, but then can't be commanded in this again.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "#11",
        ...
        recall: 2,
        type: "Ability",
        text: `When a Tag Team happens within Far range of you, you can <strong>spend a Hope</strong> to cause the initiator to only have to spend 2 Hope. If they succeed with Hope, then you gain a Hope, as well.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "Aura of Authority",
        level: 6,
        recall: 0,
        type: "Ability",
      ...
      },
      {
        ...
        recall: 3,
        type: "Ability",
        text: `Once per long rest, you can strike fear into those who oppose you. Until the end of the scene, the GM must spend a Fear to target you.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "#17",
      ...
      },
      {
        ...
        recall: 1,
        type: "Ability",
        text: `For each Scar you have, expand your loadout by +1. This card does not count towards your loadout.`,
      },
      {
        domainColor: "var(--fear-dim)",
        cardName: "#21",
